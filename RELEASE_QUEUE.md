...
- [x] **`1.0.7+26.1.2`** (2026-09-05) - Clean up config warning wording and remove repetitive notice boilerplate from option descriptions.
- [x] **`1.0.6+26.1.2`** (2026-09-05) - - **YACL Migration & Ko-fi Support**: Migrated in-game configuration GUI from Cloth Config to YetAnotherConfigLib v3 (YACL) with top-pinned Ko-fi creator support button. Upgraded to DasikLibrary 1.8.38.
