...
* 🚀 **Infinite Stack Size Virtualization**: Ground items merge into a single entity tracking a virtual count of up to **9,999 items** by default (configurable up to the integer limit of **2,147,483,647**).
